...
namespace CSProject
{
	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			while (year == 0)
			{
				Console.Write("\nPlease enter the year: "); // ask user to enter year
				try
				{
			...
			while (month == 0)
			{
				...
				try
				{
					...
					// check if user input a month number less 1 or greater than 12 
					if (month < 1 || month > 12)
					{
			...
			// read the staff.txt file from our directory
			myStaff = fr.ReadFile();
			...
			// generate payslip for each staff
	...
	class Manager : Staff
	{
		...
		// overifde base class calculatePay() method
